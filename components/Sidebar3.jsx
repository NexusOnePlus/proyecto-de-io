        ...
        <div className="h-[calc(100vh-44px)] grid place-items-center backdrop-blur-3xl bg-black/80  border-r border-gray-900">
            <nav className="font-semibold text-xl h-auto">
                ...
                <ul className="grid gap-5">
                    ...
                    <li className={`w-48 grid h-12 ${test[pathname == '/rutas/hungaro' ? 'si' : 'no']} hover:bg-white hover:text-black rounded grid place-items-center`}>
                        <Link href='/rutas/hungaro' > Húngaro </Link>
                    </li>
                </ul>
            </nav>
        </div>
